...
import type { Schedules } from '@/core/domains/schedules/schedule.types'
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <AddScheduleDialog stylistId={stylistId} />
      </div>
              ...
              {schedules.length > 0 ? (
                schedules.map((schedule) => (
                  <div key={schedule.id} className="flex items-center justify-between rounded-md bg-muted p-2 text-sm">
                    ...
                    <DeleteConfirmationDialog action={deleteScheduleAction} itemId={schedule.id}>
