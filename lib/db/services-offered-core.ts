// lib/db/services-offered-core.ts
import { createGenericCrudService } from './generic-core'
import {
  ServicesOfferedData,
  ServicesOfferedFormDataType, // Deși nu o folosim direct aici, e bine să fim conștienți de ea
} from '@/app/admin/stylists/[id]/services/types' // Asigură-te că ai creat acest fișier
import { addOfferedServiceSchema, editOfferedServiceSchema } from '../zod/schemas' // Schemele Zod definite anterior
