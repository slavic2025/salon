...
export const zPasswordsMustBeTheSame =
  <T extends Record<string, string>>(passwordFieldName: string, passwordAgainFieldName: string) =>
  (val: T, ctx: z.RefinementCtx) => {
    // val: T folosește tipul generic
...
export const loginSchema = z.object({
  ...
  password: zPasswordRequired, // Folosim noua schemă pentru parolă
})
